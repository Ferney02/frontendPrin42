...
const MostrarClientes = () => {
    ...
    const eliminarClientes = async (e, _idCliente) => {
        e.preventDefault();
        const response = await APIInvoke.invokeDELETE(`/api/clientes/${_idCliente}`);
                                        ...
                                        <tr key={index}>
                                            ...
                                            <td>
                                                <Link to={`/clientes/editar/${cliente._id}`}
                                                    className="btn btn-sm bt-primary" > Editar
                                                </Link>
                                                <button onClick={(e) => eliminarClientes(e, cliente._id)}
                                                    className="btn btn-sm bt-danger">Eliminar
                                                </button>
                                            </td>
                                        </tr>
                                    ))}
